...
import { Route as OrdersNumIndexRouteImport } from './routes/orders/$num/index'
...
const OrdersNumIndexRoute = OrdersNumIndexRouteImport.update({
  id: '/$num/',
  path: '/$num/',
  getParentRoute: () => OrdersRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/orders/$num': typeof OrdersNumIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/orders/$num/': {
      ...
      path: '/$num'
      fullPath: '/orders/$num'
      preLoaderRoute: typeof OrdersNumIndexRouteImport
      parentRoute: typeof OrdersRouteRoute
    }
    '/admin/products/': {
      id: '/admin/products/'
...
interface OrdersRouteRouteChildren {
  ...
  OrdersNumIndexRoute: typeof OrdersNumIndexRoute
}

const OrdersRouteRouteChildren: OrdersRouteRouteChildren = {
  OrdersIndexRoute: OrdersIndexRoute,
  OrdersNumIndexRoute: OrdersNumIndexRoute,
}
